...
mod tests {
    ...
    fn globs_and_greps_directory() {
        ...
        std::fs::create_dir_all(dir.join("nested")).expect("nested directory should be created");
        ...
        let globbed_dirs =
            glob_search("*/", Some(dir.to_string_lossy().as_ref())).expect("glob should succeed");
        assert_eq!(globbed_dirs.num_files, 1);
        assert!(
            globbed_dirs
                .filenames
                .iter()
